      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-2xl font-display font-bold mb-4">Career Studio</h2>
            <p className="text-gray-400 mb-4">
              Empowering job seekers with professional tools to showcase their talents and land their dream jobs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-gray-400 hover:text-white">CV Builder</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Portfolio Creator</Link></li>
              <li><Link to="#" className="text-gray-400 hover:text-white">Job Search</Link></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Career Studio. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
