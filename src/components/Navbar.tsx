      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <div className="space-x-3">
            <Button variant="outline" className="border-jobathon-600 text-jobathon-600 hover:bg-jobathon-50">Login</Button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white px-4 py-3 shadow-lg border-t animate-fade-in">
          <div className="flex flex-col space-y-4">
            ...
            <Button variant="outline" className="border-jobathon-600 text-jobathon-600 hover:bg-jobathon-50 w-full">Login</Button>
